...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forum.Data.Models.Job", b =>
                {
                    ...
                    b.Property<string>("BaseCoatingStaffId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");

                    b.Property<DateTime?>("BaseCoatingStart")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("CuttingEnd")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("CuttingStaffId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");

                    b.Property<DateTime?>("CuttingStart")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("PackingStaffId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.Property<string>("SandingStaffId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.Property<string>("TopCoatingStaffId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.HasIndex("BaseCoatingStaffId");

                    b.HasIndex("CuttingStaffId");

                    b.HasIndex("PackingStaffId");

                    b.HasIndex("SandingStaffId");

                    b.HasIndex("TopCoatingStaffId");
            ...
            modelBuilder.Entity("Forum.Data.Models.Job", b =>
                {
                    b.HasOne("Forum.Data.Models.Users.User", "BaseCoatingStaff")
                        .WithMany()
                        .HasForeignKey("BaseCoatingStaffId");

                    b.HasOne("Forum.Data.Models.Users.User", "CuttingStaff")
                        .WithMany()
                        .HasForeignKey("CuttingStaffId");

                    b.HasOne("Forum.Data.Models.Users.User", "PackingStaff")
                        .WithMany()
                        .HasForeignKey("PackingStaffId");

                    b.HasOne("Forum.Data.Models.Users.User", "SandingStaff")
                        .WithMany()
                        .HasForeignKey("SandingStaffId");

                    b.HasOne("Forum.Data.Models.Users.User", "TopCoatingStaff")
                        .WithMany()
                        .HasForeignKey("TopCoatingStaffId");

                    b.Navigation("BaseCoatingStaff");

                    b.Navigation("CuttingStaff");

                    b.Navigation("PackingStaff");

                    b.Navigation("SandingStaff");

                    b.Navigation("TopCoatingStaff");
                });
